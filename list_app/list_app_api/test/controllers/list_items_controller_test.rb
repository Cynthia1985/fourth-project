...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { description: @list_item.description, is_completed: @list_item.is_completed, name: @list_item.name, priority: @list_item.priority } }, as: :json
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { description: @list_item.description, is_completed: @list_item.is_completed, name: @list_item.name, priority: @list_item.priority } }, as: :json
    assert_response 200
  end
